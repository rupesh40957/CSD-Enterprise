        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-200 dark:border-navy-800">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link href="#hero" className="flex items-center gap-3 group">
              <div className="w-[50px] h-[32px] sm:w-[56px] sm:h-[36px] rounded-xl overflow-hidden bg-white dark:bg-navy-900 p-1 border border-slate-200 dark:border-red-500/30 shadow-sm shadow-red-500/10 flex items-center justify-center shrink-0">
                <Image
                  src={logoSrc}
